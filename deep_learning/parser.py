...
def get_parser():
    ...
    parser.add_argument('--dropout', default=0.8, type=float, help='lstm dropout')
    parser.add_argument('--lin_dropout', default=0.8, type=float, help='linear dropout')
    ...
    parser.add_argument('--weighted_loss', default=True, type=str2bool, choices=[True, False], help='whether to use weights for the loss')
