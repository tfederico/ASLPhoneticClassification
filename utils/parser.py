...
def get_parser():
    ...
    parser.add_argument('--kernel_size', default=3, type=int, help="Kernel size (must be integer for now because square kernel)")
    parser.add_argument('--pool_size', default=3, type=int, help="MaxPool size (must be integer for now because square kernel)")
